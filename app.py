...
class ASRInterface:
    def __init__(self):
        self.available_models = {
            ...
            "loko99/whisper_small_kannada_448": "Whisper Small KN -v2",
    ...
    def process_long_audio(self, audio_path: str, model_name: str, chunk_size_ms: int = 20000, overlap_ms: int = 1000) -> str:
